...
def render_new_high_menu():
    st.markdown("<div style='font-size: 1.4rem; font-weight: bold;'>🚀 주도주 모멘텀 & 코멘트 관리 (V1.8.0)</div>", unsafe_allow_html=True)
    ...
    # 💡 과거 파일에는 '최신뉴스_링크'가 없을 수 있으므로 빈 문자열로 채워주기
